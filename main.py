...
def main():
    input_text = 'Доступные рисунки: \n убегающий квадрат(1), двоичное дерево(2), ветка(3), кривая Коха(4), cнежинка Коха(5), кривая Минковского(6), "ледяной" фрактал № 1(7), кривая Леви(8), \n
